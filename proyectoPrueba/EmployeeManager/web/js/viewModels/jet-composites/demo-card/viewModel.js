  ...
  function (ko) {
    function model (context) {
      ...
      if (context.properties.name) {
        ...
        let firstInitial=initials.shift();
        let secondInitial=initials.pop();
        if(secondInitial===undefined){
            self.initials=firstInitial.toUpperCase();
        }
        else    { self.initials = (firstInitial + secondInitial).toUpperCase();}
      }
