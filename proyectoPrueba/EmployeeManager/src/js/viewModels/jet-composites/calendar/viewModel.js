    ...
    $(
        function(){
            ...
            function c(){
                     ...
                     */
                        ...
                        for(let worker of employees){
                            if(checkEmployeeVacation(new Date(currentYear,currentMonth-1,v),worker)){
                                ...
                                content_container.find("."+worker.name).css({"height":"100%","width":100/employees.length+"%","float":"left","color":"white"})
                                console.log(100/employees.length+"%");     
                            }
                    }
                ...
                for(let worker of employees){
                    content_container.find("."+worker.name).css({"background-color":employeeColors[worker.name],"color":"white"});
